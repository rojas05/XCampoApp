...
import { Cell2x2, FastArrowLeft, Home, Map, MapPin, Phone, Telegram } from "iconoir-react-native";
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.info}>
                ...
                <StyledText lines={2} width={"60%"}>12344556789,-01234567890</StyledText>
            ...
            <View style={styles.indications}>
                <StyledText title bold>Como llegar</StyledText>
