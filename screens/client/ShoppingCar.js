...
import { Label, LabelSolid, PlusCircle, Xmark } from "iconoir-react-native";
    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.containerCar}>
                ...
                <StyledText title bold>Carrito </StyledText>
            ...
            <View style={styles.products}>
                ...
                <StyledText title bold marginTop={15}>{string.client.addCar}</StyledText>
            ...
            <View style={styles.total}>
                ...
                <View style={styles.infoT}>
                    ...
                    <StyledText green bold>$20.000</StyledText>
                </View>

                <StyledText green bold title>{string.client.cash} 20.000</StyledText>
                <Text width={"80%"}>{string.client.message}</Text>

                <StyledButton title={string.client.pay} padding={10} red width={"80%"}></StyledButton>
